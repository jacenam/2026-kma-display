...
import clipImage from '../../../assets/images/slide02-clip-image-01.png'
import clipVideo from '../../../assets/videos/slide02-clip01.mp4'

export default function Slide02_GeneralAI() {
  ...
  // Auto-play: trigger forward after 3s, OR advance immediately if we resumed
  // on a slide whose video already finished playing while paused.
  useEffect(() => {
  ...
  return (
    <SlideLayout id="slide-02" ref={ref}>
      <style>{`
        .s02-privacy-title {
          animation: s02Glow 1s ease-in-out infinite;
        }
        @keyframes s02Glow {
          0%, 100% { text-shadow: 0 0 4px rgba(17,95,173,0.3); }
      ...
      <div style={{
        ...
        {/* Left: Text content */}
        <div ref={leftRef} className="s02-left" style={{ flex: '0 0 auto', maxWidth: '60%' }}>
          <p style={{
